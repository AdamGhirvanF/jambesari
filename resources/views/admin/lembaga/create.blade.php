        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                    <h3 class="card-title">Isikan Data Lembaga </h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/admin/lembaga/store" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" class="form-control" id="" required name="foto_jumbotron">
                        </div>
                    </div>
                    <!-- /.card-body -->
