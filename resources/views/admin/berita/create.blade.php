        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                    <h3 class="card-title">Isikan Data Berita </h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" class="form-control" id="" placeholder="Judul" required name="judul">
                        </div>
                        <div class="form-group">
                        <label for="">Isi</label>
                        <textarea class="form-control" name="isi" id="" cols="30" rows="10" placeholder="Isi"></textarea>
                        </div>
                        <div class="form-group">
