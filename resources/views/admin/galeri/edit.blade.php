        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/admin/galeri/edit-store/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="card-body">
                        <div class="form-group">
                        <label for="">Foto Galeri Saat Ini</label><br>
                        <img src="/img/galeri/{{$data->foto}}" alt="" style="width:50%;height:50%;"> <br> <br>
